function recommendRecipe(reqIngredient: string[], recipe: string[][]): number[] {
...
const reqIngredientList = ["java", "nodejs", "reactjs"];
...
console.log(recommendRecipe(reqIngredientList, recipeList));
