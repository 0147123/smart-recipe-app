...
// router.post('/deleteIngredient', check('email').isEmail().withMessage("Please enter a correct format"), deleteUserIngredient)
// router.post('/updateIngredient', check('email').isEmail().withMessage("Please enter a correct format"), updateUserIngredient)
